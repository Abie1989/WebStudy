              ...
              <div className="container py-lg-5 py-md-4 py-2">
                ...
                <div className="mt-5 text-more">
                  <p className="pt-md-3 sample text-center">
                    ...
                    <a href="courses.html">View All Courses <span className="pl-2 fa fa-long-arrow-right" /></a>
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="col-lg-7 feature-grid-right mt-lg-0 mt-5">
                    <div className="call-grids-w3 d-grid">
                      <div className="grids-1 box-wrap">
                        <a href="#more" className="icon"><span className="fa fa-certificate" /></a>
                      ...
                      <div className="grids-1 box-wrap">
                        <a href="#more" className="icon"><span className="fa fa-book" /></a>
                      ...
                      <div className="grids-1 box-wrap">
                        <a href="#more" className="icon"><span className="fa fa-trophy" /></a>
                        <h4><a href="#feature" className="title-head">Scholarship</a></h4>
                        <p>Vivamus a ligula quam. Ut blandit eu leo non. Duis sed dolor amet laoreet.</p>
                      </div>
                      <div className="grids-1 box-wrap">
                        <a href="#more" className="icon"><span className="fa fa-graduation-cap" /></a>
          ...
          <div className="w3l-homeblock3 py-5">
            <div className="container py-lg-5 py-md-4 py-2">
                  ...
                  <div className="top-pic1">
                    <div className="card-body blog-details">
                      ...
                      <div className="author align-items-center">
                        ...
                        <ul className="blog-meta">
                          <li>
                            <a href="#author">Bipasha Akter</a> 
                          </li>
                          <li className="meta-item blog-lesson">
                            <span className="meta-value"> Nov 19, 2020 </span>. <span className="meta-value ml-2"><span className="fa fa-clock-o" /> 1 min</span>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="mt-md-5 mt-4 text-more text-center">
                <a href="blog.html">View All Posts <span className="pl-2 fa fa-long-arrow-right" /></a>
              </div>
            </div>
          </div>
          {/* middle */}
                  ...
                  <div className="col-lg-7 feature-grid-right mt-lg-0 mt-5">
                    <div className="row">
                      <div className="col-sm-6">
                        <div className="box16">
                          <a href="#url"><img src="assets/images/abie.jpg" alt="" className="img-fluid radius-image" /></a>
                          <div className="box-content">
                            <h3 className="title"><a href="#url">Abie</a></h3>
